...
{	 	 //76543210
 ...
 PORTE = BIT(nMCU_DATA_RDY1)|BIT(nMCU_DATA_RDY0);
 	     ...
 	     //76543210
 DDRF  = BIT(USB_GP1_SPI_CONTROL_GRANTED)|BIT(nUSB_GP2_DATA_RDY0)|BIT(nUSB_GP3_DATA_RDY1)|BIT(nUSB_SM_ACCESS);  //USB_DATA_RDY pin is controlled by USB-SPI bridge chip
 PORTF = BIT(nUSB_SM_ACCESS)|BIT(nUSB_GP2_DATA_RDY0)|BIT(nUSB_GP3_DATA_RDY1);
